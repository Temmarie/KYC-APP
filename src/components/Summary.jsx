    ...
    <div className="p-6 rounded shadow-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="p-6 bg-white rounded shadow-lg">
          ...
          <button onClick={() => onEdit(1)} className="text-white bg-blue-500 p-1 px-2 rounded mt-2">
            Edit
          </button>
        </div>
        ...
        <div className="p-6 bg-white rounded shadow-lg">
          ...
          <button onClick={() => onEdit(2)} className="text-white bg-blue-500 p-1 px-2 rounded mt-2">
            Edit
          </button>
        </div>
        ...
        <div className="p-6 bg-white rounded shadow-lg">
          ...
          <button onClick={() => onEdit(3)} className="text-white bg-blue-500 p-1 px-2 rounded mt-2">
            Edit
          </button>
        </div>
        ...
        <div className="p-6 bg-white rounded shadow-lg">
          ...
          <p>
            <strong>ID Document:</strong> {formData.idDocument ? formData.idDocument.name : 'No document uploaded'}
          </p>
          <button onClick={() => onEdit(4)} className="text-white bg-blue-500 p-1 px-2 rounded mt-2">
            Edit
          </button>
        </div>
      </div>
